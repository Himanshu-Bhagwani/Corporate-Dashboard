...
const ALL_LOANS = [
  // ===== PREMIUM (Health 80+, CIBIL 750+) =====
  {
    ...
    url: 'https://www.hdfc.bank.in/business-loan',
  ...
  },
  {
    ...
    url: 'https://sbi.bank.in/web/business/sme/sme-loans',
  ...
  },
  {
    ...
    url: 'https://www.icici.bank.in/business-banking/business-loans',
  ...
  },
  {
    ...
    url: 'https://www.kotak.bank.in/en/business/loans/business-loan.html',
  ...
  },
  {
    ...
    url: 'https://www.axis.bank.in/loans/business-loan',
  ...
  },
  {
    ...
    product: 'Baroda Corporate Loan', type: 'Secured / Unsecured',
    rate: '13.5% – 16.0% p.a.', rateMin: 13.5,
    maxAmount: '₹25 Lakhs', tenure: 'Up to 60 months',
    processingFee: '1% of loan amount',
    minHealth: 60, minCibil: 700, tier: 'standard',
    features: ['Government bank rates', 'Concessional for women', 'Startup-friendly terms'],
    url: 'https://bankofbaroda.bank.in/business-banking/corporate-banking/loans-and-advances',
    color: '#f57f00', accentColor: '#003366',
  },
  {
    id: 'yes-biz', bank: 'YES Bank', domain: 'yesbank.in',
    product: 'Retail Business Loan', type: 'Unsecured',
    ...
    url: 'https://www.yes.bank.in/personal-banking/yes-individual/loans/retail-business-loans',
  ...
  },
  {
    ...
    url: 'https://pnb.bank.in/loans.html',
    color: '#003366', accentColor: '#f0ad00',
  },
  // ===== BASIC (Health 40-59, CIBIL 650-699) =====
  {
    id: 'shriram-biz', bank: 'Shriram Finance', domain: 'shriramfinance.in',
    product: 'Business Loan', type: 'Unsecured',
    rate: '15.0% – 20.0% p.a.', rateMin: 15.0,
    maxAmount: '₹30 Lakhs', tenure: 'Up to 48 months',
    processingFee: '2–3% of loan amount',
    minHealth: 40, minCibil: 650, tier: 'basic',
    features: ['Flexible eligibility criteria', 'Minimal documentation', 'Quick disbursement', 'Rural & semi-urban reach'],
    url: 'https://www.shriramfinance.in/business-loan',
    color: '#c0392b', accentColor: '#1a1a2e',
  },
  {
    ...
    minHealth: 40, minCibil: 650, tier: 'basic',
    features: ['Online application', 'Zero part-prepayment charges', 'Flexi loan option'],
  ...
  {
    id: 'cgtmse', bank: 'CGTMSE Scheme', domain: 'paisabazaar.com',
    product: 'CGTMSE Guaranteed Loan', type: 'Govt Guarantee',
    rate: '14.0% – 17.0% p.a.', rateMin: 14.0,
    maxAmount: '₹2 Crore', tenure: 'Up to 84 months',
    processingFee: '1% + annual guarantee fee',
    minHealth: 40, minCibil: 650, tier: 'basic',
    badge: 'Govt Guarantee',
    features: ['Collateral-free under CGTMSE cover', 'Up to ₹2 Cr without security', 'Available via 150+ banks', 'Lower interest due to guarantee'],
    url: 'https://www.paisabazaar.com/business-loan/cgtmse-scheme/',
  ...
  // ===== STARTER (Health <40 / low CIBIL) =====
  {
    ...
    badge: 'Govt Scheme',
    features: ['No collateral for Shishu tier', 'Interest subvention available', 'Available via all PSU banks', 'SC/ST priority lending'],
    url: 'https://www.mudra.org.in',
    color: '#f4750b', accentColor: '#1a3a5c',
  },
  {
    id: 'paisabazaar-low', bank: 'PaisaBazaar', domain: 'paisabazaar.com',
    ...
    url: 'https://www.paisabazaar.com/business-loan/low-cibil-score/',
