...
const ReportsDashboard = () => {
  ...
  const reportTypes = [
    { id: 1, title: 'Profit & Loss', key: 'pnl', description: 'Detailed breakdown of income and expenses', icon: DollarSign, gradient: 'linear-gradient(135deg, #3557ea 0%, #3557ea 100%)' },
